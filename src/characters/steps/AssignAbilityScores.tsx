...
class AssignAbilityScores extends React.Component<Props> {
...
export default connect(AssignAbilityScores.mapStateToProps, AssignAbilityScores.mapDispatchToProps)(AssignAbilityScores);
