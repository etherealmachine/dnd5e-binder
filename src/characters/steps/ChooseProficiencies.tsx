...
class ChooseProficiencies extends React.Component<Props> {
...
export default connect(ChooseProficiencies.mapStateToProps, ChooseProficiencies.mapDispatchToProps)(ChooseProficiencies);
