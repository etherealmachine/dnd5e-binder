...
class SelectEquipment extends React.Component<Props> {
...
export default connect(SelectEquipment.mapStateToProps, SelectEquipment.mapDispatchToProps)(SelectEquipment);
